#!/usr/bin/python
import sys
sys.path.insert(0, '/home/jay/Desktop/cwiid-0.6.00/python/build/lib.linux-i686-2.5')
import cwiid
import sys

def main():
	#Connect to address given on command-line, if present
	print 'Press the red button on the bottom of the Wii Balance Board to put into discoverable mode now...'
	global wiimote
	if len(sys.argv) > 1:
